...
import HolidayGifting from './SubHerderComponent/HolidayGifting';
import NewArrivals from './SubHerderComponent/NewArrivals';
import SaleDropdown from './SubHerderComponent/SaleDropdown';
...
function SubHerder() {
    ...
    const dropdownComponents={
       'Holiday Gifting': <HolidayGifting/>,
    ...
    <div className="flex flex-col mt-5">
      ...
      {activeDropdown && (
        ...
        <div className="absolute  top-[7rem] md:top-[7.50rem]  left-0  w-full  bg-white shadow p-4  z-50">
